...
{{-- <x-dpanel::sidebar.dropdown name="Menu 1" icon="bx-menu" isActive="{{ request()->segment(2) == 'menu-1' }}">
        ...
        <x-dpanel::sidebar.item name="Menu 5" icon="bx-menu" url=""
            ...
            <x-dpanel::sidebar.item name="Diet_types" icon="bx-category" url="{{ route('dpanel.diet_types.index') }}"
            isActive="{{ request()->segment(2) == 'diet_types' }}" />

            <x-dpanel::sidebar.item name="Child_types" icon="bx-category" url="{{ route('dpanel.child_types.index') }}"
            isActive="{{ request()->segment(2) == 'child_types' }}" />

            <x-dpanel::sidebar.item name="Children" icon="bx-category" url="{{ route('dpanel.children.index') }}"
            isActive="{{ request()->segment(2) == 'children' }}" />

           
            <x-dpanel::sidebar.item name="Articles" icon="bx-category" url="{{ route('dpanel.articles.index') }}"
    isActive="{{ request()->segment(2) == 'articles' }}" />

    <x-dpanel::sidebar.item name="Videos" icon="bx-category" url="{{ route('dpanel.videos.index') }}"
    isActive="{{ request()->segment(2) == 'videos' }}" />


    <x-dpanel::sidebar.item name="Meal" icon="bx-category" url="{{ route('dpanel.meals.index') }}"
    isActive="{{ request()->segment(2) == 'meals' }}" />
    
    <x-dpanel::sidebar.item name="Menus" icon="bx-category" url="{{ route('dpanel.menus.index') }}"
    isActive="{{ request()->segment(2) == 'menus' }}" />
