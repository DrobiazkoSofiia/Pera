...
export default function DescriptMealCard() {
  ...
  const { mealCard, handleDelete, addMeal, avatarSource } = route.params;
  ...
  const handlePress2 = () => {
    navigation.navigate('NewMeal', { initialMeals: mealCards });
  };
  ...
  const onAddToCart = () => {
    addToCart(mealCard);
    navigation.navigate('Cart', { username, childname, avatarSource });
  };
  const handleAddNewMeal = () => {
    navigation.navigate('NewMeal', { addMeal, username, childname, avatarSource });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      {showConfirmationModal && <View style={styles.overlay} />}
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={{ flexDirection: 'row', marginTop: 27, gap: 7 }}>
              ...
              <TouchableOpacity onPress={onDelete} style={globalStyles.modalButton}>
                <Image source={require('../assets/icons/deleteIcon.png')} style={{ width: 34, height: 34 }} />
                <Text style={[globalStyles.editButtonText]}>Delete</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
            ...
            >
              ...
              widthText={150}
              heightText={35}
              onButtonPress={handleAddNewMeal}
              titleBut="Add"
            />
