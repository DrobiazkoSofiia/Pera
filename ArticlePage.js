      ...
      <ScrollView>
        <View style={styles.content}>
          ...
          <View style={styles.textContent}>
            ...
            <Text style={[globalStyles.textDietName2, styles.subtitle]}>{article.punkt1}</Text>
            <Text style={[globalStyles.smallBlackText, styles.paragraph]}>{article.paragraph1}</Text>
            <Text style={[globalStyles.textDietName2, styles.subtitle]}>{article.punkt2}</Text>
            <Text style={[globalStyles.smallBlackText, styles.paragraph]}>{article.paragraph2}</Text>
            <Text style={[globalStyles.textDietName2, styles.subtitle]}>{article.punkt3}</Text>
            <Text style={[globalStyles.smallBlackText, styles.paragraph]}>{article.paragraph3}</Text>
